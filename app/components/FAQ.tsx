...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'It means I look at who you need to know in order to grow and make warm introductions using my existing network. These aren\'t cold emails. They\'re genuine referrals built on relationships that already exist. If you have a target list, the chances are I already know some of the people on it.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Absolutely. My network and my work are both global. I\'m based in Norfolk and it\'s where I\'m happiest, but I work with clients and speak at events across the UK and internationally.',
  },
  {
  ...
  return (
    <section id="faq" className="py-32 max-w-7xl mx-auto px-6 lg:px-12" ref={ref}>
      ...
      >
        ...
        <p className="mt-3 text-base" style={{ color: '#AAAAAA' }}>
...
function FAQItem({
  ...
  return (
    ...
    >
      ...
      >
        <span
          className="text-[18px] font-medium leading-snug group-hover:text-white/90 transition-colors"
        ...
        <span
          ...
          style={{
            color: isOpen ? '#D4920A' : 'rgba(255,255,255,0.5)',
